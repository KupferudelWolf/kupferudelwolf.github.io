...
function UVsDebug( geometry, prop = {} ) {

	prop.size = prop.size || 1024;
	if ( typeof( prop.showText ) === 'undefined' ) {
		prop.showText = true;
	}
	...
	const width = prop.size; // power of 2 required for wrapping
	const height = prop.size;
	canvas.width = width;
